...
tribble(~title, ~coauthors, ~year,
        "Event Data in Space: Spatial Models of Machine Coded Vs. Human Coded Data", "(with Benjamin Bagozzi, John Freeman, and Jennifer Holmes)", "2021") %>%
  detailed_entries(what = title,
                   when = year,
                   why  = coauthors)
```
...
tribble(~title, ~coauthors, ~conference,
        "Computationally Efficient Spatial and Spatiotemporal models estimated with Non-linear Least Squares", NA, "Polmeth 2021",
...
tribble(~what, ~description, ~when,
        ...
        'ICPSR Graduate Student Instructor', "(Empirical Modeling with Robert Franzese)", "2020-present",
        
        "ICPSR Workshop, Guest Lecturer","(Spatial Econometrics with Robert Franzese)", "2020",
...
tribble(~what, ~rank, ~why,
       ...
       "Mark Bell", "Assistant Professor", list("Political Science Department", "University of Minnesota", "Email: \\href{mailto:msbell@umn.edu}{msbell@umn.edu}", "Phone: 612-624-4144"),
